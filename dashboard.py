...
with tab2:
    ...
    with col5:
        academic_chart = px.pie(academic, values=academic['Gender'].value_counts(), names=academic['Gender'].value_counts().index, title='Academic', color = ['Male', 'Female'], color_discrete_map={'Male':'slateblue','Female':'skyblue'})
