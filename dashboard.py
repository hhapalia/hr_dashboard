...
with tab1:
    ...
    all_chart = px.pie(dashboard_data, values=dashboard_data['Gender'].value_counts(), names=dashboard_data['Gender'].value_counts().index, title='All Categories', color = dashboard_data['Gender'].value_counts().index, color_discrete_map={'Male':'slateblue','Female':'lightskyblue'})
